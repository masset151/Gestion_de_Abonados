...
public class Ventana extends JFrame implements ActionListener{
	...
	private JLabel labelzona,labelconsejo,labeleliminar,labelImprimir,labellistar;
	private JTextField zona;
	private JTable registros;
	private JTable tabla;
	private JButton boton,boton1,boton2,registrar,imprimir,boton3,boton4;
	...
	ImageIcon iconobtn = new ImageIcon("Imagenes/nuevousuario.png");
	ImageIcon iconoimpr = new ImageIcon("Imagenes/imprimir.png");
	ImageIcon banner = new ImageIcon("Imagenes/consejo.png");
	...
	public Ventana() {
		...
		MenuItem3 = new JMenuItem("Imprimir Listado de Abonados por Zona");
		menu3.add(MenuItem3);
		...
		labellistar = new JLabel("Listar");
		labellistar.setBounds(200,30,220,100);
		getContentPane().add(labellistar);
		labellistar.setVisible(false);
		...
		boton4 = new JButton("Imprimir");
		boton4.setBounds(190,210,120,20);
		add(boton4);
	...
	public void actionPerformed(ActionEvent e)  {
		...
		if(e.getSource()==MenuItem3) {
			...
			datos = zona.getText();
			codzona = Integer.parseInt(datos);
			
			try {
				Modelo.Zona.ImprimirListadoAbonados(codzona);
			} catch (IOException e1) {
				// TODO Auto-generated catch block
				e1.printStackTrace();
			}finally {
